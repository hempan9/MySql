...
/*
a.
List name of all the courses handled by each trainer
*/
...
/*
c.
List the trainer id, name of the trainers and number of differnt courses handled
*/
...
/*
d.
List the trainer ID, name of traierns, course names and the number of 
times each course has been handled
<.need to check again>
*/
...
/*
e.
Get the complete training for each batch
review for batch 3 
*/
 ...
 */
 ...
 group by b.BatchName;
 /*g:
	List the id of the trainers who have handled more than
    one course for a batch along with batch name
 */
...
/*
list all the trainers (if any) who have handled all the courses present in table
*/
